    ...
    */
    'admin' => [
        'css' => [
            ...
            'admin/plugins/fancybox/jquery.fancybox.min.css',
            'admin/plugins/swiper/swiper-bundle.min.css',
        ],
        'js' => [
            ...
            'admin/plugins/fancybox/jquery.fancybox.min.js',
            'admin/plugins/swiper/swiper-bundle.min.js',
            /**
             * Customize JS
             */
            'admin/js/admin.js'
