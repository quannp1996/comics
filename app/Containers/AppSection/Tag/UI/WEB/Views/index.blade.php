                            ...
                            <td>
                                ...
                                <div class="modal fade" id="editModal_{{ $tag->id }}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <form action="{{ route('admin_tags_update', [
                                            'id' => $tag->id
                                        ]) }}" method="POST">
                                            @csrf
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="editModalLabel">Sửa từ khóa <strong> {{ $tag->title }} </strong></h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="type" id="type" class="form-control">
                                                            <option value="">-- Chọn Loại --</option>
                                                            <option value="1" {{ $tag->type == 1 ? 'selected' : '' }}>Truyện Tranh</option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="status" id="status" class="form-control">
                                                            ...
                                                            <option value="2" {{ $tag->status == 2 ? 'selected' : '' }}>Hiển thị</option>
                                                            <option value="1" {{ $tag->status == 1 ? 'selected' : '' }}>Ẩn</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="color">Màu sắc</label>
                                                        <input type="color" class="form-control" name="color" id="color" value="{{ $tag->color }}">
                                                    </div>
                                                </div>
