                    ...
                    <fieldset class="border p-2">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"
                                ...
                                value="{{ old('manga_description.' . $language['id'] . '.title', @$manga->all_desc[$language['id']]->title) }}"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="manga_description[{{ $language['id'] }}][short_description]" id="" cols="15" rows="5" class="form-control">{{ old('manga_description.' . $language['id'] . '.short_description', @$manga->all_desc[$language['id']]->short_description) }}</textarea>
                            <small
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="manga_description[{{ $language['id'] }}][description]" id="" cols="15" rows="5" class="form-control">{{ old('manga_description.' . $language['id'] . '.description', @$manga->all_desc[$language['id']]->description) }}</textarea>
                            <small
                    ...
                    <fieldset class="border p-2">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"
                                ...
                                id="categoryTitle{{ $language['id'] }}"
                                value="{{ old('manga_description.' . $language['id'] . '.meta_keyword', @$manga->all_desc[$language['id']]->meta_keyword) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"
                                ...
                                value="{{ old('manga_description.' . $language['id'] . '.meta_title', @$manga->all_desc[$language['id']]->meta_title) }}"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" placeholder="Meta Description"
                                name="manga_description[{{ $language['id'] }}][meta_description]" id="" cols="20" rows="5">{{ old('manga_description.' . $language['id'] . '.meta_description', @$manga->all_desc[$language['id']]->meta_description) }}</textarea>
                            <small
